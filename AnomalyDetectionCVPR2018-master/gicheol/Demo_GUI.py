...
save_path = '/home/callbarian/C3D/Thief_face_caught.mp4'
...
#print("sorted list of the frame_list :",m)
    ...
    temp_img=("/home/callbarian/C3D/temp_img")
    result_video='/home/callbarian/C3D/saved_videos'
    ...
    while(cap.isOpened()):
        ...
        if m[temp][0]<=i and m[temp][1]>=i :
            cv2.imwrite('/home/callbarian/C3D/temp_img/R'+str(i).zfill(13)+'.jpg',frame)
        if m[temp][1]==i :
            temp+=1
        i+=1
    ...
    img_array=[]
    for filename in sorted(glob.glob('/home/callbarian/C3D/temp_img/*.jpg')):
    ...
    out=cv2.VideoWriter('/home/callbarian/C3D/saved_videos/Extracted_Video.avi',cv2.VideoWriter_fourcc(*'DIVX'),30,size)
    ...
    shutil.rmtree(r"/home/callbarian/C3D/temp_img")
